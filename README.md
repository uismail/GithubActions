[![Run App Usama Ismail](https://github.com/uismail/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/uismail/GithubActions/actions/workflows/run-app.yaml)
